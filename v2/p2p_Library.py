...
class AudioSender:
    ...
    def __init__(self, host, port, audio_format=pyaudio.paInt16, channels=1, rate=44100, frame_chunk=4096, BUFF_SIZE = 65536):
        self.__host = host
        self.__port = port
        ...
        self.__sending_socket.setsockopt(socket.SOL_SOCKET,socket.SO_RCVBUF,BUFF_SIZE)
...
class AudioReceiver:
    ...
    def __init__(self, host, port, slots=8, audio_format=pyaudio.paInt16, channels=1, rate=44100, frame_chunk=4096, BUFF_SIZE = 65536):
        self.__host = host
        self.__port = port
        ...
        self.__server_socket.setsockopt(socket.SOL_SOCKET,socket.SO_RCVBUF,BUFF_SIZE)
